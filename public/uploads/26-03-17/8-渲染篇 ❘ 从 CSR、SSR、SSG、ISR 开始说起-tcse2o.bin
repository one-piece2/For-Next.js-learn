...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0cac714341954b49a46dbf336da6e0ab~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.jpg#?w=750&h=108&s=19401&e=png&b=202124)

JavaScript 获得数据后，最终更新为：

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6dfd817e4b444a089889031ced76257f~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.jpg#?w=1332&h=140&s=46266&e=png&b=202124)

第二种方法是在客户端使用数据获取的库比如 [SWR](https://swr.vercel.app/ "https://swr.vercel.app/")（也是 Next.js 团队开发的）或 [TanStack Query](https://tanstack.com/query/latest/ "https://tanstack.com/query/latest/")，举个例子：
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ecc132bc3e7e4fe4a98608218746599a~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.jpg#?w=1226&h=202&s=34404&e=png&b=fefefe)

服务端会在每次请求的时候编译 HTML 文件返回给客户端。查看 HTML，这些数据可以直接看到：

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3892d6c273e74e4191ba1619f171036b~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.jpg#?w=2108&h=114&s=41646&e=png&b=202124)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/837825bf2e9c4d70a4d8abb86b842fea~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.jpg#?w=306\&h=480\&s=30167\&e=png\&b=252526)
## 4\. ISR
...
Next.js v9.5 就发布了稳定的 ISR 功能，这是当时提供的 [demo](https://reactions-demo.vercel.app/ "https://reactions-demo.vercel.app/") 效果：

![reactions-demo.gif](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/26964dd0d6c14517abe5aa90fca2bba6~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.gif#?w=1434&h=1464&s=1406805&e=gif&f=226&b=fcfcfc)

不过目前 demo 失效中。你可以在[新 demo](https://on-demand-isr.vercel.app/ "https://on-demand-isr.vercel.app/") 中测试 ISR 效果。
...
![isr.gif](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ff96d135af07484eaff5c670633bf808~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.gif#?w=665&h=178&s=83852&e=gif&f=70&b=fcfcfc)
...
1. [Next.js 9.5](https://nextjs.org/blog/next-9-5 "https://nextjs.org/blog/next-9-5")
2. [Deploying: Static Exports](https://nextjs.org/docs/app/building-your-application/deploying/static-exports "https://nextjs.org/docs/app/building-your-application/deploying/static-exports")
3. [Rendering: Server-side Rendering (SSR)](https://nextjs.org/docs/pages/building-your-application/rendering/server-side-rendering "https://nextjs.org/docs/pages/building-your-application/rendering/server-side-rendering")
4. [Rendering: Static Site Generation (SSG)](https://nextjs.org/docs/pages/building-your-application/rendering/static-site-generation "https://nextjs.org/docs/pages/building-your-application/rendering/static-site-generation")
5. [Rendering: Incremental Static Regeneration (ISR)](https://nextjs.org/docs/pages/building-your-application/rendering/incremental-static-regeneration "https://nextjs.org/docs/pages/building-your-application/rendering/incremental-static-regeneration")
6. [Rendering: Automatic Static Optimization](https://nextjs.org/docs/pages/building-your-application/rendering/automatic-static-optimization "https://nextjs.org/docs/pages/building-your-application/rendering/automatic-static-optimization")
7. [Rendering: Client-side Rendering (CSR)](https://nextjs.org/docs/pages/building-your-application/rendering/client-side-rendering "https://nextjs.org/docs/pages/building-your-application/rendering/client-side-rendering")